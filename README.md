The Chicago Mercantile Exchange (CME) [1] publishes a file from its public FTP site [2] that can be used to determine information for receiving market data for futures [3] contracts.
